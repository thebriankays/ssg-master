...
import type { UnsplashImage } from '@/libs/unsplash'
import { fetchUnsplashImagesByQuery } from '@/libs/unsplash'
import { fetchPexelsImagesByQuery } from '@/libs/pexels'
import { fetchPexelsVideosByQuery } from '@/libs/pexelsVideos'
import { createMediaFromUrl, createVideoFromUrl } from '@/libs/mediaHelper'
import {
  buildOptimizedMediaQuery,
  buildVideoSearchQuery,
  selectBestVideoFile,
} from '@/libs/mediaQueryOptimizer'
