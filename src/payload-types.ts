...
export interface SiteSetting {
  ...
  /**
   * Configure AI models for various features across the site
   */
  aiSettings: {
    defaultProvider: 'openai' | 'anthropic' | 'google';
    travelItinerary?: {
      provider?: ('inherit' | 'openai' | 'anthropic' | 'google') | null;
      model?:
        | (
            | 'gpt-4-turbo-preview'
            | 'gpt-4'
    ...
    apiKeys?: {
      /**
       * Your OpenAI API key. Also set OPENAI_API_KEY in .env
       */
      openai?: string | null;
      /**
       * Your Anthropic API key. Also set ANTHROPIC_API_KEY in .env
       */
  ...
  /**
   * Manage your connected social media accounts for automated posting
   */
  socialMediaAccounts?: {
    facebook?: {
      enabled?: boolean | null;
  ...
  socialMediaSettings?: {
    /**
     * These hashtags will be suggested for all social media posts
     */
    defaultHashtags?:
      | {
          hashtag: string;
      ...
      | null;
    /**
     * Track clicks on links shared on social media
     */
    linkTracking?: boolean | null;
    autoSchedule?: {
      enabled?: boolean | null;
      /**
       * Preferred times for auto-scheduling posts
       */
      bestTimes?:
        | {
  ...
  /**
   * Configure fonts for different parts of your website
   */
  typography?: {
    /**
     * Font for main headings like H1 and H2
     */
    primaryHeadingFont?: string | null;
    /**
     * Font for smaller headings
     */
    secondaryHeadingFont?: string | null;
    /**
     * Font for paragraphs and general text content
     */
    bodyFont?: string | null;
    /**
     * Font for navigation menus and links
     */
    navigationFont?: string | null;
    /**
     * Font for buttons and CTAs
     */
    buttonFont?: string | null;
    /**
     * Font for blockquotes and testimonials
     */
    ...
    /**
     * Configure the type scale for your website
     */
    fontScale?: {
      /**
      ...
      /**
       * Mathematical ratio for scaling font sizes
       */
      scaleRatio?: ('1.067' | '1.125' | '1.2' | '1.25' | '1.333' | '1.414' | '1.5' | '1.618') | null;
    };
    globalSettings?: {
      lineHeight?: ('1.2' | '1.4' | '1.6' | '1.8' | '2') | null;
      letterSpacing?: ('-0.05' | '-0.025' | 'normal' | '0.025' | '0.05' | '0.1') | null;
      /**
       * Space between paragraphs in rem units
       */
      paragraphSpacing?: number | null;
    };
    fontLoading?: {
      /**
       * How fonts should be loaded and displayed
       */
      strategy?: ('auto' | 'block' | 'swap' | 'fallback' | 'optional') | null;
      /**
       * Preload primary fonts for better performance
       */
...
export interface SiteSettingsSelect<T extends boolean = true> {
  ...
  typography?:
    | T
    | {
        primaryHeadingFont?: T;
        secondaryHeadingFont?: T;
        bodyFont?: T;
        navigationFont?: T;
        buttonFont?: T;
        quoteFont?: T;
